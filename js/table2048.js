...
class TableRow extends React.Component {
    ...
    render() {
        return (React.createElement("div", null, React.createElement(TableGrid, {index_x: this.grid0.index_x, index_y: this.grid0.index_y, value: this.grid0.value}), React.createElement(TableGrid, {index_x: this.grid1.index_x, index_y: this.grid1.index_y, value: this.grid1.value}), React.createElement(TableGrid, {index_x: this.grid2.index_x, index_y: this.grid2.index_y, value: this.grid2.value}), React.createElement(TableGrid, {index_x: this.grid3.index_x, index_y: this.grid3.index_y, value: this.grid3.value}), React.createElement("br", null), React.createElement("br", null)));
    }
}
